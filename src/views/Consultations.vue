<template>
  <div class="dashboard-container">
    ...
    <main class="main-content">
      ...
      <AddConsultation :show="showAddConsultationModal" @close="showAddConsultationModal = false" @add-consultation="handleAddConsultation" />
      ...
      <div class="page-content">
        ...
        <div class="page-header-section">
          <div class="title-section">
            ...
            <p class="page-subtitle">Manage patient consultation records and prescriptions</p>
          </div>

          <div class="header-actions">
            <div class="search-control-inline">
              <i class="search-icon-inline">🔍</i>
              <input type="text" v-model="tableSearch" placeholder="Search consultations..." aria-label="Search consultations" />
            </div>
            ...
            <table class="consultations-table">
              ...
              <tbody>
                <tr v-for="consultation in filteredConsultations" :key="consultation.id">
                  <td class="name-cell">{{ consultation.name }}</td>
                  <td>{{ consultation.diagnosis }}</td>
                  <td>{{ consultation.prescribedMedicine }}</td>
                  <td>{{ consultation.quantity }}</td>
                  <td class="notes-cell">{{ consultation.notes }}</td>
                  <td>{{ consultation.date }}</td>
                  <td>
                    <button class="action-btn view-btn" @click="viewConsultation(consultation)" title="View Details">
                      📄
                    </button>
                  </td>
                </tr>
...
export default {
      ...
      consultations: [
        {
          ...
          diagnosis: 'Flu',
          prescribedMedicine: 'Paracetamol',
          quantity: 10,
          notes: 'Take Paracetamol Every 4-6 Hours',
          date: '2026-02-22'
        },
        {
          id: 2,
          name: 'MARY JANE SANTOS',
          diagnosis: 'Severe Headache',
          prescribedMedicine: 'Ibuprofen',
          quantity: 3,
          notes: 'Take NSAIDs With Food To Avoid Stomach Irritation.',
          date: '2026-04-027'
        },
        {
          id: 3,
          name: 'RENZ ANGELO SEFUENTES',
          diagnosis: 'Cough And Colds',
          prescribedMedicine: 'Loperamide',
          quantity: 5,
          notes: 'Hydration Is The Top Priority',
          date: '2026-11-023'
        },
        {
          id: 4,
          ...
          prescribedMedicine: 'Cetirizine',
          quantity: 5,
          notes: 'Drink Every 4 Hours',
          date: '2026-11-03'
        },
        {
          id: 5,
          name: 'MARIA THERESA PABLO',
        ...
        },
        {
          ...
          name: 'LEBRON JAMES',
          diagnosis: 'Fever',
          prescribedMedicine: 'Mefenamic Acid',
          quantity: 5,
          notes: 'Drink Every 4 Hours',
          date: '2026-04-24'
        }
    ...
    filteredConsultations() {
      ...
      if (this.tableSearch.trim()) {
        ...
        filtered = filtered.filter(c => 
          ...
          c.prescribedMedicine.toLowerCase().includes(search) ||
  ...
  methods: {
    ...
    handleAddConsultation(newConsultation) {
      ...
      const consultation = {
        ...
        prescribedMedicine: newConsultation.prescribedMedicine,
        quantity: newConsultation.quantity,
        notes: newConsultation.notes,
        date: newConsultation.date
      }
      this.consultations.push(consultation)
      alert(`Consultation for ${newConsultation.name} has been added successfully!`)
    },
    viewConsultation(consultation) {
      console.log('View consultation:', consultation)
      alert(`Viewing consultation details:\nPatient: ${consultation.name}\nDiagnosis: ${consultation.diagnosis}\nMedicine: ${consultation.prescribedMedicine}`)
      // TODO: Implement view consultation details modal/page
    }
  }
}
</script>
...
.consultations-table tbody tr:nth-child(even) {
  background: #fafafa;
}

.consultations-table tbody tr:nth-child(even):hover {
  background: #f3f4f6;
}
